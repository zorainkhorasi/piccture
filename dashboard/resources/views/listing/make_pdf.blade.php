                        ...
                        @if (isset($data['get_randomized_table']) && $data['get_randomized_table'] != '')
                            @foreach ($data['get_randomized_table'] as $k=>$r)
                                ...
                                <tr>
                                    ...
                                    <td class="text-left">{{isset($r->hhid) && $r->hhid!=''? $r->hhid:'-'}}</td>
                                    <td class="text-left">{{isset($r->hl14c) && $r->hl14c!=''? $r->hl14c:'-'}}</td>
                                    <td class="text-left">{{isset($r->hl14a) && $r->hl14a!=''? $r->hl14a:'-'}}</td>
                                    <td class="text-left">{{isset($r->head) &&$r->head!=''?ucfirst($r->head):'-'}}</td>
