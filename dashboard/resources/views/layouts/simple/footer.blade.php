...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-xl-block">
    ...
    <div class="customizer-content p-2">
        ...
        <div class="cz-bg-image row">
            <div class="col mb-3">
                <img src="{{asset(config('global.asset_path_bnp').'/assets/images/backgrounds/04.jpg')}}" class="rounded sidiebar-bg-img"
                     width="50" height="100" alt="background image" onclick="menuBGimg(this)">
            </div>
            <div class="col mb-3">
                <img src="{{asset(config('global.asset_path_bnp').'/assets/images/backgrounds/01.jpg')}}"
                     class="rounded sidiebar-bg-img selected"
                     width="50" selected
                     height="100" alt="background image" onclick="menuBGimg(this)">
            </div>
            <div class="col mb-3">
                <img src="{{asset(config('global.asset_path_bnp').'/assets/images/backgrounds/02.jpg')}}" class="rounded sidiebar-bg-img"
                     width="50"
                     height="100" alt="background image" onclick="menuBGimg(this)">
            </div>
            <div class="col mb-3">
                <img src="{{asset(config('global.asset_path_bnp').'/assets/images/backgrounds/05.jpg')}}" class="rounded sidiebar-bg-img"
                     width="50"
                     height="100" alt="background image" onclick="menuBGimg(this)">
            </div>
        </div>
