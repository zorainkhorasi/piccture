    ...
    <div class="content-wrapper">
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-8 col-12 mb-2 breadcrumb-new">
                <h3 class="content-header-title mb-0 d-inline-block">Dashboard Users</h3>
                <div class="breadcrumbs-top d-inline-block">
                    <div class="breadcrumb-wrapper mr-1">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Settings</a>
                            </li>
                            <li class="breadcrumb-item active">Dashboard Users
                            </li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Dashboard Users
                                        ...
                                        <div class="mb-1 form-group userPasswordDiv">
                                            ...
                                            <div class="mb-3 mt-1 small ">
                                                ...
                                                <ul class=" list-group">
                                                    ...
                                                    <li class="list-group-item p-1"><p id="special_character "
                                                                                       class="special_character  invalid mytext-sm">
                                                            A <b>Special character</b></p></li>
                                                </ul>
                                            </div>
                                        </div>
                                        <div class="mb-1 form-group">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-2 form-group userPasswordDiv">
                                            <label class="col-form-label" for="ediedit_userPasswordt_userPassword">Password</label>
...
<script src="{{asset(config('global.asset_path').'/js/select2/select2.full.min.js')}}"></script>
    <script>
        $(document).ready(function () {
            ...
            custome_validatePwd('userPassword');
            custome_validatePwd('edit_userPassword');
            custome_validatePwd('edit_userPasswordConfirm');
/*
            $('.myselect2').select2({
        ...
        function resetPwd() {
            ...
            if (custome_validatePwdInp('edit_userPassword') == 1) {
                $('#edit_userPassword').css('border', '1px solid red');
                flag = 1;
        ...
        function addData() {
            ...
            if (custome_validatePwdInp('userPassword') == 1) {
                $('#userPassword').css('border', '1px solid red');
                flag = 1;
                toastMsg('Password', 'Password format Issue', 'danger');
                return false;
