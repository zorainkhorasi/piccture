        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="mb-2 form-group userPasswordDiv">
                   ...
                   <!--  <div class="form-control-position toggle-password mt-1">
                        <i class="ft-eye-off pwdIcon"></i>
                    </div> -->


                    <div class="mb-3 mt-1 small  ml-1">
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        showFirstPwdModal(1);
        custome_validatePwd('pwdExpiry');
        custome_validatePwd('edit_newPassword');
        custome_validatePwd('edit_newPasswordConfirm');
    });
    ...
    function changePassword() {
        ...
        if (custome_validatePwdInp('edit_newPassword')==1) {
            $('#edit_newPassword').css('border', '1px solid red');
            flag = 1;
